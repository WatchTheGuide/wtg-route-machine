...
const uk = {
  translation: {
    ...
    tours: {
      ...
      bulkDeleteDialog: {
        title: 'Ви впевнені, що хочете видалити вибрані екскурсії?',
        description:
          'Ця дія незворотна. {{count}} екскурсій буде остаточно видалено.',
      },
      // Toast messages
    ...
    tourEditor: {
      ...
      media: {
        ...
        images: 'Зображення',
        hint: 'Виберіть зображення з медіатеки або завантажте нові.',
      },
      details: {
    ...
    // Media Manager
    media: {
      title: 'Бібліотека Медіа',
      subtitle: 'Керування зображеннями та медіафайлами',
      upload: 'Завантажити Зображення',
      search: 'Шукати медіа...',
      filters: 'Фільтри',
      noResults: 'Медіа не знайдено',
      noResultsDesc: 'Завантажте зображення, щоб почати',
      selectImages: 'Виберіть зображення або перетягніть',
      dropHere: 'Перетягніть файли сюди',
      maxFileSize: 'Макс. розмір файлу: {{size}} на зображення',
      maxFiles: 'Максимум {{max}} файлів одночасно',
      uploadSuccess: '{{count}} зображень успішно завантажено',
      uploadError: 'Помилка завантаження',
      deleteConfirm: 'Видалити це зображення? Цю дію неможливо скасувати.',
      deleteSuccess: 'Зображення видалено',
      deleteError: 'Помилка видалення',
      updateSuccess: 'Зображення оновлено',
      ...
      tags: 'Теги',
      imageTitle: 'Назва',
      titlePlaceholder: 'Введіть назву зображення',
      altText: 'Альтернативний Текст',
      altTextPlaceholder: 'Опишіть зображення для доступності',
      tagsPlaceholder: "місто, пам'ятка, архітектура",
      tagsHelp: 'Розділіть теги комами',
      contextType: 'Контекст',
      standalone: 'Окремо',
      tourImages: 'Зображення Турів',
      poiImages: 'Зображення POI',
      allMedia: 'Всі Медіа',
      usedIn: 'Використано в',
      filename: "Ім'я Файлу",
      tour: 'Тур',
      poi: 'POI',
      uploading: 'Завантаження...',
      uploadFiles: 'Завантажити {{count}} файлів',
      noFilesSelected: 'Файли не вибрано',
      fileTooLarge: '{{name}} занадто великий. Максимум {{max}}',
      tooManyFiles: 'Занадто багато файлів. Максимум {{max}} одночасно',
      selected: 'Вибрано {{count}}',
      uploadFirst: 'Завантажте своє перше зображення',
      totalMedia: '{{count}} медіафайлів',
      showing: 'Показано {{count}} результатів',
